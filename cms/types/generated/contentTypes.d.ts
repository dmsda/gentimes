...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    aiReadinessScore: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    author: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'GenTimes Editorial'>;
    ...
    keyTakeaway: Schema.Attribute.Text &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 200;
      }>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    readabilityScore: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    ...
    trendingScore: Schema.Attribute.Float & Schema.Attribute.DefaultTo<0>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    viewCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    viewsLast24h: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    viewsLast7d: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
  };
}
...
export interface ApiPageViewPageView extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Analytics: tracks page views per article';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    device: Schema.Attribute.Enumeration<['mobile', 'desktop', 'tablet']> &
